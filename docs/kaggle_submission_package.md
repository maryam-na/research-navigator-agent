...
Search-first research discovery across local papers, extracted statements, gaps, hypotheses, and experiment plans.

### Evidence Inspector

Statement-level evidence review with source paper, chunk ID, quality signals, and linked gaps/hypotheses.

### Ranked Discoveries

Evidence-backed research gaps, speculative hypotheses, and linked experiment plans.

### Knowledge Graph

Local NetworkX graph preview connecting papers, statements, methods, results, limitations, datasets, and future work.

### Safety And Evaluation

Grounding, safety, testability, traceability, warnings, and failed-check reporting.
